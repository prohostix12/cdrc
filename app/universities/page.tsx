...
const UNI_GRADIENTS: Record<string, [string, string]> = {
  ...
  // Edufolio universities
  'aligarh-muslim-university':                  ['#15803d', '#166534'],
  'gla-university':                             ['#b45309', '#92400e'],
  'manipal-university-jaipur':                  ['#0369a1', '#075985'],
  'amrita-vishwa-vidyapeetham':                 ['#be123c', '#9f1239'],
  'mizoram-university':                         ['#6d28d9', '#5b21b6'],
  'andhra-university':                          ['#0e7490', '#155e75'],
  'swami-vivekanand-subharti-university':       ['#b91c1c', '#991b1b'],
  'shiv-nadar-university':                      ['#1d4ed8', '#1e3a8a'],
  'srm-institute-of-science-and-technology':    ['#7c2d12', '#6c2d12'],
  'vellore-institute-of-technology':            ['#047857', '#065f46'],
  'hindustan-institute-of-technology-and-science': ['#7e22ce', '#6b21a8'],
  'symbiosis-international-university':         ['#0f766e', '#0d9488'],
  'narsee-monjee-institute-of-management-studies': ['#c2410c', '#9a3412'],
};
